...
class EditPembelian extends EditRecord
{
        ...
        DB::transaction(function () use ($pembelian, $oldPembelianDetails) {
            ...
            foreach ($oldPembelianDetails as $oldDetail) {
                ...
                if (!$stillExists) {
                    ...
                    // Tidak perlu mengelola riwayat lagi
                }
            }
            ...
            foreach ($pembelian->pembelianDetails as $detail) {
                ...
                if (!$oldDetail) {
                    ...
                    // Tidak perlu membuat riwayat pembelian lagi
                    continue;
                }
                ...
                if ($oldDetail['jumlah_pembelian'] != $detail->jumlah_pembelian) {
                    ...
                    // Tidak perlu update riwayat pembelian lagi
                    continue;
                }
    ...
    // Fungsi-fungsi helper untuk riwayat pembelian telah dihapus
